...
function NavBar() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "sticky top-0 z-50 border-b", style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "/", className: "flex items-center gap-2.5 no-underline", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full flex items-center justify-center shrink-0", style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-bold text-sm tracking-wide", style: {
        color: "hsl(40 20% 97%)"
      }, children: [
        "hidraulika",
