          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <Reveal delay={80}>
              {(() => {
                ...
                const cities = [
                  { n: "Győr",         x: 156, y: 120, ly: -12, d: "M345,172 Q250,130 156,120" },
                  { n: "Szombathely",  x: 56,  y: 205, ly: 19,  d: "M345,172 Q195,168 56,205" },
                  { n: "Zalaegerszeg", x: 90,  y: 294, ly: 19,  d: "M345,172 Q210,248 90,294" },
                  { n: "Pécs",         x: 231, y: 347, ly: 19,  d: "M345,172 Q276,270 231,347" },
                  { n: "Szeged",       x: 442, y: 319, ly: 19,  d: "M345,172 Q400,250 442,319" },
                  { n: "Kecskemét",    x: 398, y: 268, ly: 19,  d: "M345,172 Q368,222 398,268" },
                  { n: "Békéscsaba",   x: 543, y: 288, ly: 19,  d: "M345,172 Q460,234 543,288" },
                  { n: "Debrecen",     x: 598, y: 207, ly: 19,  d: "M345,172 Q478,180 598,207" },
                  { n: "Nyíregyháza",  x: 629, y: 136, ly: -12, d: "M345,172 Q495,132 629,136" },
          ...
          <div className="flex gap-2 p-2">
            ...
            <button onClick={scrollToTop} aria-label="Vissza a tetejére" tabIndex={atBottom ? 0 : -1}
              ...
              style={{
                ...
                background: ORANGE, border: "none", borderRadius: 3, color: "#04140d",
                boxShadow: "0 6px 18px rgba(253,185,39,0.3)",
